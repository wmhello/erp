<template>
   <div id="cate">
      <div id="datagrid">
        <div class="toolbar">
          <el-button  plain icon="el-icon-plus" @click="add()" >添加种类</el-button>
          <el-button  plain icon="el-icon-plus" @click="upload()" >导入</el-button>
        </div>
         <!-- 教师基本信息表 -->
         <el-table :data="tableData" border  @select-all="selectChange" @selection-change="selectChange" v-loading="loading">
            ...
            <el-table-column label="种类名称" prop="name" width="200">
            </el-table-column>
            <el-table-column label="所属种类" width="200">
      ...
      <!-- 编辑列表 -->
      <el-dialog title="物品种类管理" center  :visible.sync="editDialogFormVisible" :close-on-click-modal="false">
         <el-form :model="form" :rules="rules" ref="ruleForm" label-width="100px">
            <el-row>
               ...
               <el-col :span="12">
                  <el-form-item label="所属种类" prop="pid">
                      <el-select v-model="form.pid" placeholder="请选择所属类型">
       ...
       data() {
         return {
            searchForm: new SearchModel(),
                  ...
                  types:['无'],
                  templateFile: config.site + '/xls/cate.xlsx',
         }
       },
       created() {
         this.fetchData()
